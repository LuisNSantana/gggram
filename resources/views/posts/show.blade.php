                ...
                @if ($post->user_id === auth()->user()->id)
                    <form action="{{ route('posts.destroy', $post) }}" method="POST">
                        ...
                        <input type="submit" value="Eliminar Publicacion"
                            class="bg-red-500 hover:bg-red-600 p-3 rounded font-bold mt-4 cursor-pointer text-white">
                    </form>
                @endif
            @endauth
            <div>
                ...
                @auth
                    ...
                    <form action="{{ route('comentarios.store', ['post' => $post, 'user' => $user]) }}" method="POST">
                        ...
                        <div class="mb-5">
                            ...
                            <textarea name="comentario" id="comentario" placeholder="Escribe un comentario"
